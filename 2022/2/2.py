...
for scenario in l:
    match scenario[1]:
        case You.X:
            your_choice = list(filter(lambda x: x[0] == scenario[0], LOSE_SCENARIOS)).pop()[1]
        case You.Y:
            your_choice = list(filter(lambda x: x[0] == scenario[0], DRAW_SCENARIOS)).pop()[1]
            c += 3
        case You.Z:
            your_choice = list(filter(lambda x: x[0] == scenario[0], WIN_SCENARIOS)).pop()[1]
            c += 6
